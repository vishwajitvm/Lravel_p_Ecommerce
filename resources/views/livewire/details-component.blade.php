            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <h2 class="product-name"> {{ Str::title($product->name) }} </h2>
                        ...
                        <div class="stock-info in-stock">
                            <p class="availability">Availability: <b> {{ $product->stock_status=='instock'?"In stock":"Out of stock" }} </b></p>
                        </div>
                        <div class="quantity">
                            <span>Quantity:</span>
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{ Route('product.details',['slug'=>$popular_product->slug]) }}" title="{{ Str::title($popular_product->name) }}">
                                            <figure><img src="{{ asset('assets/images/products')}}/{{ $popular_product->image }}" alt="{{ Str::title($popular_product->name) }}"></figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <a href="{{ Route('product.details',['slug'=>$popular_product->slug]) }}" class="product-name"><span>{{ Str::title($popular_product->name) }}</span></a>
                    ...
                    <div class="wrap-products">
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            ...
                            <div class="product product-style-2 equal-elem ">
                                ...
                                <div class="product-info">
                                    <a href="{{ Route('product.details',['slug'=>$related_product->slug]) }}" class="product-name"><span> {{ Str::title($related_product->name) }} </span></a>
